...
<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        ...
        <input type="text" id="tags_input" class="formulario__input" placeholder="Ej. Node.js, PHP, CSS, Laravel, etc.">
    </div>
...
<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        <div class="formulario__contenedor-icono">
            ...
            <input type="text" class="formulario__input--sociales" name="redes[X]" placeholder="X"
